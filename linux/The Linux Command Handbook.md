...
-   [Introduction to Linux and shells](https://www.freecodecamp.org/news/the-linux-commands-handbook/#introductiontolinuxandshells)
-   [The Linux `man` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-man-command)
-   [The Linux `ls` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-ls-command)
-   [The Linux `cd` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-cd-command)
-   [The Linux `pwd` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-pwd-command)
-   [The Linux `mkdir` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-mkdir-command)
-   [The Linux `rmdir` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-rmdir-command)
-   [The Linux `mv` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-mv-command)
-   [The Linux `cp` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-cp-command)
-   [The Linux `open` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-open-command)
-   [The Linux `touch` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-touch-command)
-   [The Linux `find` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-find-command)
-   [The Linux `ln` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-ln-command)
-   [The Linux `gzip` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-gzip-command)
-   [The Linux `gunzip` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-gunzip-command)
-   [The Linux `tar` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-tar-command)
-   [The Linux `alias` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-alias-command)
-   [The Linux `cat` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-cat-command)
-   [The Linux `less` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-less-command)
-   [The Linux `tail` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-tail-command)
-   [The Linux `wc` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-wc-command)
-   [The Linux `grep` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-grep-command)
-   [The Linux `sort` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-sort-command)
-   [The Linux `uniq` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-uniq-command)
-   [The Linux `diff` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-diff-command)
-   [The Linux `echo` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-echo-command)
-   [The Linux `chown` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-chown-command)
-   [The Linux `chmod` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-chmod-command)
-   [The Linux `umask` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-umask-command)
-   [The Linux `du` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-du-command)
-   [The Linux `df` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-df-command)
-   [The Linux `basename` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-basename-command)
-   [The Linux `dirname` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-dirname-command)
-   [The Linux `ps` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-ps-command)
-   [The Linux `top` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-top-command)
-   [The Linux `kill` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-kill-command)
-   [The Linux `killall` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-killall-command)
-   [The Linux `jobs` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-jobs-command)
-   [The Linux `bg` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-bg-command)
-   [The Linux `fg` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-fg-command)
-   [The Linux `type` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-type-command)
-   [The Linux `which` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-which-command)
-   [The Linux `nohup` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-nohup-command)
-   [The Linux `xargs` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-xargs-command)
-   [The Linux `vim` editor command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-vim-editor-command)
-   [The Linux `emacs` editor command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-emacs-editor-command)
-   [The Linux `nano` editor command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-nano-editor-command)
-   [The Linux `whoami` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-whoami-command)
-   [The Linux `who` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-who-command)
-   [The Linux `su` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-su-command)
-   [The Linux `sudo` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-sudo-command)
-   [The Linux `passwd` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-passwd-command)
-   [The Linux `ping` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-ping-command)
-   [The Linux `traceroute` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-traceroute-command)
-   [The Linux `clear` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-clear-command)
-   [The Linux `history` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-history-command)
-   [The Linux `export` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-export-command)
-   [The Linux `crontab` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-crontab-command)
-   [The Linux `uname` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-uname-command)
-   [The Linux `env` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-env-command)
-   [The Linux `printenv` command](https://www.freecodecamp.org/news/the-linux-commands-handbook/#the-linux-printenv-command)
-   [Conclusion](https://www.freecodecamp.org/news/the-linux-commands-handbook/#conclusion)
...
![Screen-Shot-2020-07-04-at-18.42.40](https://www.freecodecamp.org/news/content/images/2020/10/Screen-Shot-2020-07-04-at-18.42.40.png)
...
![Screen-Shot-2020-09-07-at-07.35.41](https://www.freecodecamp.org/news/content/images/2020/10/Screen-Shot-2020-09-07-at-07.35.41.png)
...
I **publish programming tutorials** every day on my website [flaviocopes.com](https://flaviocopes.com/) if you want to check out more great content like this.
