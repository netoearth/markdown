## [](https://plantegg.github.io/2021/06/01/CPU%E7%9A%84%E5%88%B6%E9%80%A0%E5%92%8C%E6%A6%82%E5%BF%B5/#CPU%E7%9A%84%E5%88%B6%E9%80%A0%E5%92%8C%E6%A6%82%E5%BF%B5 "CPU的制造和概念")CPU的制造和概念
...
### [](https://plantegg.github.io/2021/06/01/CPU%E7%9A%84%E5%88%B6%E9%80%A0%E5%92%8C%E6%A6%82%E5%BF%B5/#%E5%85%89%E5%88%BB "光刻")光刻
...
### [](https://plantegg.github.io/2021/06/01/CPU%E7%9A%84%E5%88%B6%E9%80%A0%E5%92%8C%E6%A6%82%E5%BF%B5/#Die%E5%92%8Ccore "Die和core")Die和core
...
## [](https://plantegg.github.io/2021/06/01/CPU%E7%9A%84%E5%88%B6%E9%80%A0%E5%92%8C%E6%A6%82%E5%BF%B5/#%E7%8E%B0%E4%BB%A3CPU%E7%9A%84%E5%9F%BA%E6%9C%AC%E6%9E%B6%E6%9E%84 "现代CPU的基本架构")[现代CPU的基本架构](https://frankdenneman.nl/2016/07/08/numa-deep-dive-part-2-system-architecture/)
...
[![image-20210602165525641](https://plantegg.github.io/images/951413iMgBlog/image-20210602165525641.png)](https://plantegg.github.io/images/951413iMgBlog/image-20210602165525641.png)
...
### [](https://plantegg.github.io/2021/06/01/CPU%E7%9A%84%E5%88%B6%E9%80%A0%E5%92%8C%E6%A6%82%E5%BF%B5/#%E6%8C%87%E4%BB%A4%E9%9B%86%E4%BC%98%E5%8C%96 "指令集优化")指令集优化
...
[![Skylake SP 28 Core Die Mesh](https://plantegg.github.io/images/951413iMgBlog/Skylake-SP-28-Core-Die-Mesh-800x666.jpg)](https://plantegg.github.io/images/951413iMgBlog/Skylake-SP-28-Core-Die-Mesh-800x666.jpg)
...
[![Broadwell Ring V Skylake Mesh DRAM Example](https://plantegg.github.io/images/951413iMgBlog/Broadwell-Ring-v-Skylake-Mesh-DRAM-Example-696x272.jpg)](https://plantegg.github.io/images/951413iMgBlog/Broadwell-Ring-v-Skylake-Mesh-DRAM-Example-696x272.jpg)
...
[![image-20210602104851803](https://plantegg.github.io/images/951413iMgBlog/image-20210602104851803.png)](https://plantegg.github.io/images/951413iMgBlog/image-20210602104851803.png)

### [](https://plantegg.github.io/2021/06/01/CPU%E7%9A%84%E5%88%B6%E9%80%A0%E5%92%8C%E6%A6%82%E5%BF%B5/#SUB-NUMA-Cluster-SNC "SUB_NUMA Cluster(SNC)")SUB\_NUMA Cluster(SNC)

在intel 8269的CPU中，core比较多，core之间通信采取的是mesh架构，实际在BIOS中的NUMA NODE设置上，还有个sub\_numa的设置，开启后，一个Die拆成了两个node

[![image-20220418101937564](https://plantegg.github.io/images/951413iMgBlog/image-20220418101937564.png)](https://plantegg.github.io/images/951413iMgBlog/image-20220418101937564.png)

</p><p>       1  82.1  78.1 134.1 137.6</p><p>       2 129.8 135.8  73.5  81.7</p><p>       3 134.4 137.7  81.7  78.5</p><p>Measuring Peak Injection Memory Bandwidths for the system</p><p>Bandwidths are in MB/sec (1 MB/sec = 1,000,000 Bytes/sec)</p><p>Using all the threads from each core if Hyper-threading is enabled</p><p>Using traffic with the following read-write ratios</p><p>ALL Reads        :232777.7</p><p>3:1 Reads-Writes :216680.7</p><p>2:1 Reads-Writes :213856.4</p><p>1:1 Reads-Writes :197430.7</p><p>Stream-triad like:194310.3</p><p>Measuring Memory Bandwidths between nodes within system</p><p>Bandwidths are in MB/sec (1 MB/sec = 1,000,000 Bytes/sec)</p><p>Using all the threads from each core if Hyper-threading is enabled</p><p>Using Read-only traffic type</p><p>Numa node</p><p>Numa node     0     1     2     3</p><p>       058908.959066.050548.050479.6</p><p>       159111.358882.650539.050479.3</p><p>       250541.750495.858950.258934.0</p><p>       350526.350492.459171.958701.5</p><p>Measuring Loaded Latencies for the system</p><p>Using all the threads from each core if Hyper-threading is enabled</p><p>Using Read-only traffic type</p><p>InjectLatencyBandwidth</p><p>Delay(ns)MB/sec</p><p>==========================</p><p> 00000242.78 232249.0</p><p> 00002242.90 232248.8</p><p> 00008242.63 232226.0</p><p> 00015247.47 233159.0</p><p> 00050250.26 233489.7</p><p> 00100245.88 233253.4</p><p> 00200109.72 183071.9</p><p> 00300 93.95 128676.2</p><p> 00400 88.51  98678.4</p><p> 00500 85.15  80026.2</p><p> 00700 83.74  58136.1</p><p> 01000 82.16  41372.4</p><p> 01300 81.59  32184.0</p><p> 01700 81.14  24896.1</p><p> 02500 80.80  17248.5</p><p> 03500 80.32  12571.3</p><p> 05000 79.58   9060.5</p><p> 09000 78.27   5411.6</p><p> 20000 76.09   2911.5</p><p>Measuring cache-to-cache transfer latency (in ns)...</p><p>Local Socket L2-&gt;L2 HIT  latency45.0</p><p>Local Socket L2-&gt;L2 HITM latency45.1</p><p>Remote Socket L2-&gt;L2 HITM latency (data address homed in writer socket)</p><p>Reader Numa Node</p><p>Writer Numa Node     0     1     2     3</p><p>            0     -  48.2 107.2 109.2</p><p>            1  50.6     - 111.2 113.1</p><p>            2 107.6 109.6     -  48.0</p><p>            3 111.6 113.5  49.7     -</p><p>Remote Socket L2-&gt;L2 HITM latency (data address homed in reader socket)</p><p>Reader Numa Node</p><p>Writer Numa Node     0     1     2     3</p><p>            0     -  48.6 169.1 175.0</p><p>            1  46.3     - 167.9 172.1</p><p>            2 171.4 175.3     -  48.6</p><p>            3 169.7 173.6  45.1     -</p><p>[root@registry Linux]# numactl -H</p><p>available: 4 nodes (0-3)</p><p>node 0 cpus: 0 1 2 3 7 8 9 13 14 15 20 21 22 52 53 54 55 59 60 61 65 66 67 72 73 74</p><p>node 0 size: 64162 MB</p><p>node 0 free: 60072 MB</p><p>node 1 cpus: 4 5 6 10 11 12 16 17 18 19 23 24 25 56 57 58 62 63 64 68 69 70 71 75 76 77</p><p>node 1 size: 65536 MB</p><p>node 1 free: 63575 MB</p><p>node 2 cpus: 26 27 28 29 33 34 35 39 40 41 46 47 
p><p>114</p><p>115</p><p>116</p><p>117</p><p>118</p><p>119</p><p>120</p><p>121</p><p>122</p><p>123</p><p>124</p><p>125</p><p>126</p><p>127</p><p>128</p><p>129</p><p>130</p><p>131</p><p>132</p><p>133</p><p>134</p><p>135</p><p>136</p><p>137</p><p>138</p><p>139</p><p>140</p><p>141</p><p>142</p><p>143</p><p>144</p><p>145</p><p>146</p></pre></td><td><pre><p>lscpu:</p><p>      Architecture:        x86_64</p><p>      CPU op-mode(s):      32-bit, 64-bit</p><p>      Byte Order:          Little Endian</p><p>      CPU(s):              96</p><p>      On-line CPU(s) list: 0-95</p><p>      Thread(s) per core:  2</p><p>      Core(s) per socket:  24</p><p>      Socket(s):           2</p><p>      NUMA node(s):        4</p><p>      Vendor ID:           GenuineIntel</p><p>      CPU family:          6</p><p>      Model:               85</p><p>      Model name:          Intel(R) Xeon(R) Platinum 8260 CPU @ 2.40GHz</p><p>      Stepping:            6</p><p>      CPU MHz:             2400.000</p><p>      CPU max MHz:         3900.0000</p><p>      CPU min MHz:         1000.0000</p><p>      BogoMIPS:            4800.00</p><p>      Virtualization:      VT-x</p><p>      L1d cache:           32K</p><p>      L1i cache:           32K</p><p>      L2 cache:            1024K</p><p>      L3 cache:            36608K</p><p>      NUMA node0 CPU(s):   0-3,7-9,13-15,19,20,48-51,55-57,61-63,67,68</p><p>      NUMA node1 CPU(s):   4-6,10-12,16-18,21-23,52-54,58-60,64-66,69-71</p><p>      NUMA node2 CPU(s):   24-27,31-33,37-39,43,44,72-75,79-81,85-87,91,92</p><p>      NUMA node3 CPU(s):   28-30,34-36,40-42,45-47,76-78,82-84,88-90,93-95</p><p> Model: 85</p><p> Model name: Intel(R) Xeon(R) Platinum 8268 CPU @ 2.90GHz</p><p> Stepping: 6</p><p> CPU MHz: 3252.490</p><p> BogoMIPS: 5800.00</p><p> Virtualization: VT-x</p><p> L1d cache: 32K</p><p> L1i cache: 32K</p><p> L2 cache: 1024K</p><p> L3 cache: 36608K</p><p> NUMA node0 CPU(s):</p><p> 0,4,8,12,16,20,24,28,32,36,40,44,48,52,56,60,64,68,72,76,80,84,88,92</p><p> NUMA node1 CPU(s):</p><p> 1,5,9,13,17,21,25,29,33,37,41,45,49,53,57,61,65,69,73,77,81,85,89,93</p><p> NUMA node2 CPU(s):</p><p> 2,6,10,14,18,22,26,30,34,38,42,46,50,54,58,62,66,70,74,78,82,86,90,94</p><p> NUMA node3 CPU(s):</p><p> 3,7,11,15,19,23,27,31,35,39,43,47,51,55,59,63,67,71,75,79,83,87,91,95   </p><p>  lscpu:</p><p> Architecture: x86_64</p><p> CPU op-mode(s): 32-bit, 64-bit</p><p> Byte Order: Little Endian</p><p> CPU(s): 192</p><p> On-line CPU(s) list: 0-191</p><p> Thread(s) per core: 1</p><p> Core(s) per socket: 24</p><p> Socket(s): 8 //每个物理CPU 24个物理core，这24个core应该是分布在2个Die中</p><p> NUMA node(s): 16</p><p> Vendor ID: GenuineIntel</p><p> CPU family: 6</p><p> Model: 85</p><p> Model name: Intel(R) Xeon(R) Platinum 8260 CPU @ 2.40GHz</p><p> Stepping: 7</p><p> CPU MHz: 2400.000</p><p> CPU max MHz: 3900.0000</p><p> CPU min MHz: 1000.0000</p><p> BogoMIPS: 4800.00</p><p> Virtualization: VT-x</p><p> L1d cache: 32K</p><p> L1i cache: 32K</p><p> L2 cache: 1024K</p><p> L3 cache: 36608K</p><p> NUMA node0 CPU(s): 0-3,7-9,13-15,19,20</p><p> NUMA node1 CPU(s): 4-6,10-12,16-18,21-23</p><p> NUMA node2 CPU(s): 24-27,31-33,37-39,43,44</p><p> NUMA node3 CPU(s): 28-30,34-36,40-42,45-47</p><p> NUMA node4 CPU(s): 48-51,55,56,60-62,66-68</p><p> NUMA node5 CPU(s): 52-54,57-59,63-65,69-71</p><p> NUMA node6 CPU(s): 72-75,79-81,85-87,91,92</p><p> NUMA node7 CPU(s): 76-78,82-84,88-90,93-95</p><p> NUMA node8 CPU(s): 96-99,103,104,108-110,114-116</p><p> NUMA node9 CPU(s): 100-102,105-107,111-113,117-119</p><p> NUMA node10 CPU(s): 120-123,127,128,132-134,138-140</p><p> NUMA node11 CPU(s): 124-126,129-131,135-137,141-143</p><p> NUMA node12 CPU(s): 144-147,151-153,157-159,163,164</p><p> NUMA node13 CPU(s): 148-150,154-156,160-162,165-167</p><p> NUMA node14 CPU(s): 168-171,175-177,181-183,187,188</p><p> NUMA node15 CPU(s): 172-174,178-180,184-186,189-191</p><p> //v62</p><p> #lscpu</p><p>Architecture:          x86_64</p><p>CPU op-mode(s):        32-bit, 64-bit</p><p>Byte Order:            Little Endian</p><p>CPU(s):                104</p><p>On-line CPU(s) list:   0-103</p><p>Thread(s) per core:    2</p><p>Core(s) per socket:    26</p><p>Socket(s):             2</p><p>NUMA node(s):          2</p><p>Vendor ID:             GenuineIntel</p><p>CPU family:            6</p><p>Model:                 85</p><p>Model name:            Intel(R) Xeon(R) Platinum 8269CY CPU @ 2.50GHz</p><p>Stepping:              7</p><p>CPU MHz:               3200.097</p><p>CPU max MHz:           3800.0000</p><p>CPU min MHz:           1200.0000</p><p>BogoMIPS:              4998.89</p><p>Virtualization:        VT-x</p><p>L1d cache:             32K</p><p>L1i cache:             32K</p><p>L2 cache:              1024K</p><p>L3 cache:              36608K</p><p>NUMA node0 CPU(s):     0-25,52-77</p><p>NUMA node1 CPU(s):     26-51,78-103</p><p>//2016Intel开始出售Intel Xeon E5-2682 v4。 这是一种基于Broadwell架构的桌面处理器，主要为办公系统而设计。 它具有16 核心和32 数据流并使用, 售价约为7000人民币</p><p>#lscpu</p><p>Architecture:          x86_64</p><p>CPU op-mode(s):        32-bit, 64-bit</p><p>Byte Order:            Little Endian</p><p>CPU(s):                64</p><p>On-line CPU(s) list:   0-63</p><p>Thread(s) per core:    2</p><p>Core(s) per socket:    16</p><p>Socket(s):             2</p><p>NUMA node(s):          2</p><p>Vendor ID:             GenuineIntel</p><p>CPU family:            6</p><p>Model:                 79</p><p>Model name:            Intel(R) Xeon(R) CPU E5-2682 v4 @ 2.50GHz</p><p>Stepping:              1</p><p>CPU MHz:               2499.902</p><p>CPU max MHz:           3000.0000</p><p>CPU min MHz:           1200.0000</p><p>BogoMIPS:              5000.06</p><p>Virtualization:        VT-x</p><p>L1d cache:             32K</p><p>L1i cache:             32K</p><p>L2 cache:              256K</p><p>L3 cache:              40960K</p><p>NUMA node0 CPU(s):     0-15,32-47</p><p>NUMA node1 CPU(s):     16-31,48-63</p><p>Flags:                 fpu vme de pse tsc msr pae mce cx8 apic sep mtrr pge mca cmov pat pse36 clflush dts acpi mmx fxsr sse sse2 ss ht tm pbe syscall nx pdpe1gb rdtscp lm constant_tsc arch_perfmon pebs bts rep_good nopl xtopology nonstop_tsc aperfmperf eagerfpu pni pclmulqdq dtes64 ds_cpl vmx smx est tm2 ssse3 fma cx16 xtpr pdcm pcid dca sse4_1 sse4_2 x2apic movbe popcnt tsc_deadline_timer aes xsave avx f16c rdrand lahf_lm abm 3dnowprefetch ida arat epb invpcid_single pln pts dtherm spec_ctrl ibpb_support tpr_shadow vnmi flexpriority ept vpid fsgsbase tsc_adjust bmi1 hle avx2 smep bmi2 erms invpcid rtm cqm rdt rdseed adx smap xsaveopt cqm_llc cqm_occup_llc cqm_mbm_total cqm_mbm_local cat_l3</p></pre></td></tr></tbody></table>

### [](https://plantegg.github.io/2021/06/01/CPU%E7%9A%84%E5%88%B6%E9%80%A0%E5%92%8C%E6%A6%82%E5%BF%B5/#intel-%E6%9E%B6%E6%9E%84%E8%BF%AD%E4%BB%A3 "intel 架构迭代")[intel 架构迭代](https://jcf94.com/2018/02/13/2018-02-13-intel/)

[![Intel processor roadmap](https://plantegg.github.io/images/oss/94d79c38-b577-4d31-b40c-fbec4cdc5f2e.png)](https://plantegg.github.io/images/oss/94d79c38-b577-4d31-b40c-fbec4cdc5f2e.png)
...
[![img](https://plantegg.github.io/images/951413iMgBlog/313d469d57e6b92eyy03dee63614a72c.png)](https://plantegg.github.io/images/951413iMgBlog/313d469d57e6b92eyy03dee63614a72c.png)
...
## [](https://plantegg.github.io/2021/06/01/CPU%E7%9A%84%E5%88%B6%E9%80%A0%E5%92%8C%E6%A6%82%E5%BF%B5/#%E7%8E%B0%E5%9C%BA%E5%8F%AF%E7%BC%96%E7%A8%8B%E9%97%A8%E9%98%B5%E5%88%97FPGA%EF%BC%88Field-Programmable-Gate-Array%EF%BC%89 "现场可编程门阵列FPGA（Field-Programmable Gate Array）")现场可编程门阵列FPGA（Field-Programmable Gate Array）
...
## [](https://plantegg.github.io/2021/06/01/CPU%E7%9A%84%E5%88%B6%E9%80%A0%E5%92%8C%E6%A6%82%E5%BF%B5/#%E4%B8%93%E7%94%A8%E9%9B%86%E6%88%90%E7%94%B5%E8%B7%AFASIC%EF%BC%88Application-Specific-Integrated-Circuit%EF%BC%89 "专用集成电路ASIC（Application-Specific Integrated Circuit）")专用集成电路ASIC（Application-Specific Integrated Circuit）
...
## [](https://plantegg.github.io/2021/06/01/CPU%E7%9A%84%E5%88%B6%E9%80%A0%E5%92%8C%E6%A6%82%E5%BF%B5/#%E5%BC%A0%E9%87%8F%E5%A4%84%E7%90%86%E5%99%A8TPU-%EF%BC%88tensor-processing-unit%EF%BC%89 "张量处理器TPU （tensor processing unit）")张量处理器TPU （tensor processing unit）
...
## [](https://plantegg.github.io/2021/06/01/CPU%E7%9A%84%E5%88%B6%E9%80%A0%E5%92%8C%E6%A6%82%E5%BF%B5/#%E5%85%B6%E5%AE%83%E5%9F%BA%E7%A1%80%E7%9F%A5%E8%AF%86 "其它基础知识")其它基础知识
...
[![img](https://plantegg.github.io/images/951413iMgBlog/997341ed0fa9018561c7120c19cfa2a7.jpg)](https://plantegg.github.io/images/951413iMgBlog/997341ed0fa9018561c7120c19cfa2a7.jpg)
...
[![img](https://plantegg.github.io/images/951413iMgBlog/1144d3a2d4f3f4f87c349a93429805c8.jpg)](https://plantegg.github.io/images/951413iMgBlog/1144d3a2d4f3f4f87c349a93429805c8.jpg)
...
## [](https://plantegg.github.io/2021/06/01/CPU%E7%9A%84%E5%88%B6%E9%80%A0%E5%92%8C%E6%A6%82%E5%BF%B5/#%E5%AE%8F%E8%A7%82%E8%AE%A4%E8%AF%86%E9%9B%86%E6%88%90%E7%94%B5%E8%B7%AF%E5%8D%8A%E5%AF%BC%E4%BD%93%E8%A1%8C%E4%B8%9A "宏观认识集成电路半导体行业")宏观认识集成电路半导体行业

先从市场分布和市场占有率等几个行业宏观概念来了解半导体行业

### [](https://plantegg.github.io/2021/06/01/CPU%E7%9A%84%E5%88%B6%E9%80%A0%E5%92%8C%E6%A6%82%E5%BF%B5/#%E5%8D%8A%E5%AF%BC%E4%BD%93%E4%BA%A7%E4%B8%9A%E7%9A%84%E4%BA%A7%E5%80%BC%E5%88%86%E5%B8%83 "半导体产业的产值分布")半导体产业的产值分布

下图中的处理器就是我们日常所说的CPU，当然还包含了GPU等

我们常说的内存、固态硬盘这些存储器也是数字IC，后面你会看到一个CPU core里面还会有用于存储的cache电路

[![img](https://plantegg.github.io/images/951413iMgBlog/be159461be7c0a5569be21b30a24db50.png)](https://plantegg.github.io/images/951413iMgBlog/be159461be7c0a5569be21b30a24db50.png)

### [](https://plantegg.github.io/2021/06/01/CPU%E7%9A%84%E5%88%B6%E9%80%A0%E5%92%8C%E6%A6%82%E5%BF%B5/#%E4%BB%8E%E4%B8%80%E5%8F%B0iPhone%E6%9D%A5%E7%9C%8B%E9%9B%86%E6%88%90%E7%94%B5%E8%B7%AF%E5%92%8C%E8%8A%AF%E7%89%87 "从一台iPhone来看集成电路和芯片")从一台iPhone来看集成电路和芯片

先看一台iPhone X拆解分析里面的所有芯片：

[![img](https://plantegg.github.io/images/951413iMgBlog/8bbc7b771359dfc07c81ca2a064cb30c.jpg)](https://plantegg.github.io/images/951413iMgBlog/8bbc7b771359dfc07c81ca2a064cb30c.jpg)

### [](https://plantegg.github.io/2021/06/01/CPU%E7%9A%84%E5%88%B6%E9%80%A0%E5%92%8C%E6%A6%82%E5%BF%B5/#%E5%85%A8%E7%90%83%E5%8D%8A%E5%AF%BC%E4%BD%93%E8%90%A5%E6%94%B6%E5%88%86%E5%B8%83 "全球半导体营收分布")全球半导体营收分布

[![img](https://plantegg.github.io/images/951413iMgBlog/d3a2690aaf6be233d08404c108fc4449.png)](https://plantegg.github.io/images/951413iMgBlog/d3a2690aaf6be233d08404c108fc4449.png)

美光：美国；Hynix海力士：韩国现代；美国双通：高通(CDMA)、博通(各种买买买、并购，网络设备芯片)；欧洲双雄(汽车芯片)：恩智浦和英飞凌

半导体行业近 5 年的行业前十的公司列了如下：

[![img](https://plantegg.github.io/images/951413iMgBlog/639990db9d26a8a54d1baaf3d6e513d4.png)](https://plantegg.github.io/images/951413iMgBlog/639990db9d26a8a54d1baaf3d6e513d4.png)

#### [](https://plantegg.github.io/2021/06/01/CPU%E7%9A%84%E5%88%B6%E9%80%A0%E5%92%8C%E6%A6%82%E5%BF%B5/#%E5%8D%8A%E5%AF%BC%E4%BD%93%E4%BA%A7%E5%93%81%E7%9A%84%E5%8D%81%E5%A4%A7%E4%B9%B0%E5%AE%B6 "半导体产品的十大买家")半导体产品的十大买家

BBK是步步高集团，包含vivo、oppo、oneplus、realme等

[![img](https://plantegg.github.io/images/951413iMgBlog/3bb8531b7ab4c503436838ab15434310.png)](https://plantegg.github.io/images/951413iMgBlog/3bb8531b7ab4c503436838ab15434310.png)

### [](https://plantegg.github.io/2021/06/01/CPU%E7%9A%84%E5%88%B6%E9%80%A0%E5%92%8C%E6%A6%82%E5%BF%B5/#%E5%9B%BD%E5%86%85%E5%8D%8A%E5%AF%BC%E4%BD%93%E5%B8%82%E5%9C%BA%E6%83%85%E5%86%B5 "国内半导体市场情况")国内半导体市场情况
...
[![img](https://plantegg.github.io/images/951413iMgBlog/a37bd5e13f2920fb2e85a7907cdc852a.jpeg)](https://plantegg.github.io/images/951413iMgBlog/a37bd5e13f2920fb2e85a7907cdc852a.jpeg)
...
### [](https://plantegg.github.io/2021/06/01/CPU%E7%9A%84%E5%88%B6%E9%80%A0%E5%92%8C%E6%A6%82%E5%BF%B5/#%E5%B7%A5%E8%89%BA "工艺")工艺

光刻的粒度越来越细，玩家也越来越少，基本主流都是代工模式：

[![img](https://plantegg.github.io/images/951413iMgBlog/beebe27eacd37075dyy37a4182169f04.png)](https://plantegg.github.io/images/951413iMgBlog/beebe27eacd37075dyy37a4182169f04.png)

[![img](https://plantegg.github.io/images/951413iMgBlog/5eb09cde20395b84ff8c746c27d9f7b7.jpg)](https://plantegg.github.io/images/951413iMgBlog/5eb09cde20395b84ff8c746c27d9f7b7.jpg)

晶体管密度比较

[![image-20210728095829384](https://plantegg.github.io/images/951413iMgBlog/image-20210728095829384.png)](https://plantegg.github.io/images/951413iMgBlog/image-20210728095829384.png)

## [](https://plantegg.github.io/2021/06/01/CPU%E7%9A%84%E5%88%B6%E9%80%A0%E5%92%8C%E6%A6%82%E5%BF%B5/#%E8%AE%A1%E7%AE%97%E6%9C%BA%E8%8A%AF%E7%89%87%E5%8F%91%E5%B1%95%E6%80%BB%E7%BB%93%E5%92%8C%E5%B1%95%E6%9C%9B "计算机芯片发展总结和展望")[计算机芯片发展总结和展望](https://weibo.com/ttarticle/p/show?id=2309404745052319777615)
...
[![f6.jpg](https://plantegg.github.io/images/951413iMgBlog/f6.jpg)](https://plantegg.github.io/images/951413iMgBlog/f6.jpg)
...
[![f3.jpg](https://plantegg.github.io/images/951413iMgBlog/f3.jpg)](https://plantegg.github.io/images/951413iMgBlog/f3.jpg)
...
[![f5.jpg](https://plantegg.github.io/images/951413iMgBlog/f5.jpg)](https://plantegg.github.io/images/951413iMgBlog/f5.jpg)

大概从2000年左右CPU的性能增长开始放缓，到2018年实际性能比摩尔定律预估的差了15倍（注意纵坐标是指数级），因为CMOS技术已经接近极限

[![f2.jpg](https://plantegg.github.io/images/951413iMgBlog/f2.jpg)](https://plantegg.github.io/images/951413iMgBlog/f2.jpg)

> [CMOS](https://baike.baidu.com/item/CMOS)电路是互补型金属[氧化物半导体](https://baike.baidu.com/item/%E6%B0%A7%E5%8C%96%E7%89%A9%E5%8D%8A%E5%AF%BC%E4%BD%93/6199658)电路(Complementary Metal-Oxide-Semiconductor)的英文字头缩写，它由绝缘[场效应晶体管](https://baike.baidu.com/item/%E5%9C%BA%E6%95%88%E5%BA%94%E6%99%B6%E4%BD%93%E7%AE%A1/2293646)组成，由于只有一种[载流子](https://baike.baidu.com/item/%E8%BD%BD%E6%B5%81%E5%AD%90/7163305)，因‘而是一种[单极型晶体管](https://baike.baidu.com/item/%E5%8D%95%E6%9E%81%E5%9E%8B%E6%99%B6%E4%BD%93%E7%AE%A1/9003337)集成电路，其基本结构是一个N沟道[MOS管](https://baike.baidu.com/item/MOS%E7%AE%A1/8703611)和一个P沟道MOS管
...
### [](https://plantegg.github.io/2021/06/01/CPU%E7%9A%84%E5%88%B6%E9%80%A0%E5%92%8C%E6%A6%82%E5%BF%B5/#%E8%AE%A1%E7%AE%97%E6%9C%BA%E6%9E%B6%E6%9E%84%E7%9A%84%E6%9C%AA%E6%9D%A5%E6%9C%BA%E9%81%87 "计算机架构的未来机遇")[计算机架构的未来机遇](https://cacm.acm.org/magazines/2019/2/234352-a-new-golden-age-for-computer-architecture/fulltext#body-6)
...
[![f7.jpg](https://plantegg.github.io/images/951413iMgBlog/f7.jpg)](https://plantegg.github.io/images/951413iMgBlog/f7.jpg)

#### [](https://plantegg.github.io/2021/06/01/CPU%E7%9A%84%E5%88%B6%E9%80%A0%E5%92%8C%E6%A6%82%E5%BF%B5/#%E7%89%B9%E5%AE%9A%E9%A2%86%E5%9F%9F%E7%9A%84%E4%BD%93%E7%B3%BB%E7%BB%93%E6%9E%84%EF%BC%88DSA%EF%BC%89 "特定领域的体系结构（DSA）")特定领域的体系结构（DSA）
...
#### [](https://plantegg.github.io/2021/06/01/CPU%E7%9A%84%E5%88%B6%E9%80%A0%E5%92%8C%E6%A6%82%E5%BF%B5/#%E5%BC%80%E6%94%BE%E5%BC%8F%E6%9E%B6%E6%9E%84%EF%BC%88Open-Architectures%EF%BC%89 "开放式架构（Open Architectures）")开放式架构（Open Architectures）

RISC-V

## [](https://plantegg.github.io/2021/06/01/CPU%E7%9A%84%E5%88%B6%E9%80%A0%E5%92%8C%E6%A6%82%E5%BF%B5/#%E6%80%BB%E7%BB%93 "总结")总结
...
## [](https://plantegg.github.io/2021/06/01/CPU%E7%9A%84%E5%88%B6%E9%80%A0%E5%92%8C%E6%A6%82%E5%BF%B5/#%E7%B3%BB%E5%88%97%E6%96%87%E7%AB%A0-1 "系列文章")系列文章
